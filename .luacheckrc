...
stds["WoW"] = {
	globals = {
		...
		"debugprofilestart", "debugprofilestop", "split",

		-- Common Globals
		"UIParent", "UISpecialFrames", "CreateFrame", "CreateColor", "CreateFont", "CreateFromMixins", "GameTooltip", "UIWidgetManager",
		"CopyTable", "GetTime", "GetBuildInfo", "ReloadUI", "StaticPopup_Show", "IsForbidden", "NegateIf", "GetRaidRosterInfo", "UnitHasVehicleUI",
		"UnitInRaid",
