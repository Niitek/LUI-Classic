...
local f = CreateFrame("Frame", "LUI_Frame_Identifier", UIParent, BackdropTemplateMixin and "BackdropTemplate")
f:SetWidth(320)
f:SetHeight(20)
f:SetPoint("CENTER")
...
--[[ MOUSEOVER INFO ]]
local f2 = CreateFrame("FRAME", "LUI_Frame_MouseInfo", LUI_Frame_Identifier, BackdropTemplateMixin and "BackdropTemplate")
f2:SetHeight(32)
f2:SetWidth(320)
...
local f3 = CreateFrame("Button", "LUI_Frame_CloseButton", LUI_Frame_Identifier, BackdropTemplateMixin and "BackdropTemplate")
