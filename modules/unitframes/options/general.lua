...
function module:CreateXpRepOptionsPart(barType, order)
	...
	if barType == "XP" then
		toggleFunc = function()
			...
			if self.db.XP_Rep.Experience.Enable and UnitLevel("player") ~= LEVEL_CAP then
