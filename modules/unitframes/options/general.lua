...
function module:CreatePlayerBarOptions(barType, order)
	...
	local options = self:NewGroup(barName, order, {
		...
		-- need to sort out later for shamans, TWW patch borked it.
		-- ShowIcons = (barType == "Totems" and class == "Shaman") and self:NewToggle("Show Totem Icons", "Whether you want to show the "..barName.." icons or not\nRequires a reload!", 3, applySettings, nil ,disabledFunc),
...
function module:CreateUnitOptions(unit, order)
	...
	local options = self:NewGroup(unit, order * 2 + 10, "tab", nil, disabledUnitFunc, {
		...
		Bars = self:NewGroup("Bars", 3, "tab", nil, disabledFunc, {
			...
			HolyPower = (class == "PALADIN" and unit == "Player" and LUI.isMists) and self:CreatePlayerBarOptions("HolyPower", 15) or nil,
			WarlockBar = (class == "WARLOCK" and unit == "Player" and LUI.isMists) and self:CreatePlayerBarOptions("WarlockBar", 16) or nil,
			ShadowOrbsBar = (class == "PRIEST" and unit == "Player" and LUI.isMists) and self:CreatePlayerBarOptions("ShadowOrbsBar", 16) or nil,
			ArcaneCharges = (class == "MAGE" and unit == "Player" and LUI.isMists) and self:CreatePlayerBarOptions("ArcaneCharges", 16) or nil,
			...
			Eclipse = (class == "DRUID" and unit == "Player" and LUI.isMists) and self:CreatePlayerBarOptions("Eclipse", 17) or nil,
