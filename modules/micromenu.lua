...
function module:SetColors()
	...
	LUI.MicroMenu.Buttons.Store:SetBackdropColor(r, g, b, 1)
 	-- LUI.MicroMenu.Buttons.LFG:SetBackdropColor(r, g, b, 1)  --Uncommented for Classic Compatibility
	-- LUI.MicroMenu.Buttons.Journal:SetBackdropColor(r, g, b, 1) ]] --Uncommented for Classic Compatibility
	-- lUI.MicroMenu.Buttons.PVP:SetBackdropColor(r, g, b, 1) ]] --Uncommented for Classic Compatibility
	LUI.MicroMenu.Buttons.Guild:SetBackdropColor(r, g, b, 1)
	LUI.MicroMenu.Buttons.Quests:SetBackdropColor(r, g, b, 1)
--[[ 	LUI.MicroMenu.Buttons.AC:SetBackdropColor(r, g, b, 1) ]] --Uncommented for Classic Compatibility
...
function module:SetMicroMenu()
	...
	LUI.MicroMenu.Anchor = LUI:CreateMeAFrame("Frame", nil, UIParent, 128, 128, 1, "HIGH", 2, "TOPRIGHT", UIParent, "TOPRIGHT", -200, 6, 1)
	...
	LUI.MicroMenu.Button = LUI:CreateMeAFrame("Frame", nil, UIParent, 390, 512, 1, "BACKGROUND", 1, "TOPRIGHT", UIParent, "TOPRIGHT", 0, -1, 1)  -- Classic 1.13.5
	--LUI.MicroMenu.Button = LUI:CreateMeAFrame("Frame", nil, UIParent, 590, 512, 1, "BACKGROUND", 1, "TOPRIGHT", UIParent, "TOPRIGHT", 0, -1, 1)  -- Retail 9.0.1
	...
	LUI.MicroMenu.Button.BG = LUI:CreateMeAFrame("Frame", nil, LUI.MicroMenu.Button, 390, 512, 1, "BACKGROUND", 0, "TOPRIGHT", LUI.MicroMenu.Button, "TOPRIGHT", -0, 0, 1)  -- Classic 1.13.5
	--LUI.MicroMenu.Button.BG = LUI:CreateMeAFrame("Frame", nil, LUI.MicroMenu.Button, 590, 512, 1, "BACKGROUND", 0, "TOPRIGHT", LUI.MicroMenu.Button, "TOPRIGHT", 0, 0, 1) -- Retail 9.0.1
...
--[[  --Added with 3.0.2 WOTLK
LUI.MicroMenu.Buttons.Pets = LUI:CreateMeAFrame("Frame", nil, LUI.MicroMenu.Buttons.Store, 64, 64, 1, "BACKGROUND", 3, "LEFT", LUI.MicroMenu.Buttons.Store, "LEFT", -33, 0, 1)  --Uncommented for Classic Compatibility
...
--[[ LUI.MicroMenu.Buttons.LFG = LUI:CreateMeAFrame("Frame", nil, LUI.MicroMenu.Buttons.Pets, 64, 64, 1, "BACKGROUND", 3, "LEFT", LUI.MicroMenu.Buttons.Pets, "LEFT", -33, 0, 1)  --Uncommented for Classic Compatibility
	...
	LUI.MicroMenu.Buttons.LFG.Clicker:SetScript("OnUpdate", function(self, button)  --Uncommented for Classic Compatibility
...
--[[ 	LUI.MicroMenu.Buttons.Journal = LUI:CreateMeAFrame("Frame", nil, LUI.MicroMenu.Buttons.LFG, 64, 64, 1, "BACKGROUND", 3, "LEFT", LUI.MicroMenu.Buttons.LFG, "LEFT", -33, 0, 1)  --Uncommented for Classic Compatibility
	...
	LUI.MicroMenu.Buttons.Guild = LUI:CreateMeAFrame("Frame",nil,LUI.MicroMenu.Buttons.Store,64,64,1,"BACKGROUND",3,"LEFT",LUI.MicroMenu.Buttons.Store,"LEFT",-33,0, 1)
	...
	LUI.MicroMenu.Buttons.Guild.Clicker:SetScript("OnClick", function(self, button)
		...
		elseif button == "RightButton" then
			...
			if GuildFrame:IsShown() --[[ or LookingForGuildFrame:IsShown() ]] then  --Uncommented for Classic Compatibility
				if IsInGuild() then HideUIPanel(GuildFrame) --[[ else HideUIPanel(LookingForGuildFrame) ]] end  --Uncommented for Classic Compatibility
			else
				if IsInGuild() then ShowUIPanel(GuildFrame) --[[ else ShowUIPanel(LookingForGuildFrame) ]] end  --Uncommented for Classic Compatibility
			end
		end
	end)
	...
	GuildFrame:HookScript("OnHide", function(self)
		if not FriendsFrame:IsShown() --[[ and not LookingForGuildFrame:IsShown() ]] and not LUI.MicroMenu.Buttons.Guild.Clicker.State then  --Uncommented for Classic Compatibility
			LUI.MicroMenu.Buttons.Guild.Clicker:SetAlpha(0)
		end
	end)

--[[ 	if not LookingForGuildFrame then					--Uncommented for Classic Compatibility
	...
	--[[ LUI.MicroMenu.Buttons.AC = LUI:CreateMeAFrame("Frame", nil, LUI.MicroMenu.Buttons.Quests, 64, 64, 1, "BACKGROUND", 3, "LEFT", LUI.MicroMenu.Buttons.Quests, "LEFT", -33, 0, 1)  --Uncommented for Classic Compatibility
...
--[[ 	LUI.MicroMenu.Buttons.Talents = LUI:CreateMeAFrame("Frame", nil, LUI.MicroMenu.Buttons.AC, 64, 64, 1, "BACKGROUND", 3, "LEFT", LUI.MicroMenu.Buttons.AC, "LEFT", -33, 0, 1)  --Uncommented for Classic Compatibility
 ]]	LUI.MicroMenu.Buttons.Talents = LUI:CreateMeAFrame("Frame", nil, LUI.MicroMenu.Buttons.Quests, 64, 64, 1, "BACKGROUND", 3, "LEFT", LUI.MicroMenu.Buttons.Quests, "LEFT", -33, 0, 1)
	...
	if not PlayerTalentFrame then
		...
		-- Fix for Events firing before PlayerTalentFrame is fully loaded (aka: blizz fail with patch 4.0.6)
		ShowUIPanel(PlayerTalentFrame)
		HideUIPanel(PlayerTalentFrame)
	end
