...
function module:LoadOptions()
	...
	local colorOptions = {"By Theme", "Individual", "Gradient"}
...
function module:Refresh(...)
	...
	if db.Appearance.Color == "By Theme" then
		r, g, b = unpack(Themes.db.profile.bar2)
	...
	if db.Text.Color == "By Theme" then
		r, g, b = unpack(Themes.db.profile.bar2)
