...
function module:SetTooltip()
	...
	local healthBarBG = CreateFrame( "Frame", "StatusBarBG", healthBar, BackdropTemplateMixin and "BackdropTemplate")
	...
	healthBarBG:SetBackdrop({
		bgFile = "media\textures\blank.blp",
		edgeFile = "media\textures\blank.blp",
		edgeSize = 0,
...
--[[ 			self:SetBackdropBorderColor(r, g, b, a)
	...
	end) ]] --uncommented for classic compatiblility
end
